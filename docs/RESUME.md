...
- Validated Kubernetes observability with Container Insights pod/node KQL records, a real fired Azure Monitor failed-pod alert, Prometheus 18/18 active targets, an application replica metric, and Grafana's supplied Kubernetes dashboards; Action Group email confirmation remains a separate human gate.
